 ...
 */
package com.thinkgem.jeesite.modules.agent.product.entity;
...
public class Product extends DataEntity<Product> {
	...
	private Date beginListingdate;		// 开始 上市时间
	private Date endListingdate;		// 结束 上市时间
	private String beginTotal;		// 开始 库存
	private String endTotal;		// 结束 库存
	...
	public Date getBeginListingdate() {
		return beginListingdate;
	}

	public void setBeginListingdate(Date beginListingdate) {
		this.beginListingdate = beginListingdate;
	}
	
	public Date getEndListingdate() {
		return endListingdate;
	}

	public void setEndListingdate(Date endListingdate) {
