 ...
 */
@Controller
@RequestMapping(value = "${adminPath}/agent/supplier")
public class SupplierController extends BaseController {
	...
	@RequiresPermissions("agent:supplier:view")
	...
	public String list(Supplier supplier, HttpServletRequest request, HttpServletResponse response, Model model) {
		...
		return "agent/agent/supplierList";
	}
	...
	public String form(Supplier supplier, Model model) {
		...
		return "agent/agent/supplierForm";
	}

	@RequiresPermissions("agent:supplier:edit")
	...
	public String save(Supplier supplier, Model model, RedirectAttributes redirectAttributes) {
		...
		return "redirect:"+Global.getAdminPath()+"/agent/supplier/?repage";
	}
