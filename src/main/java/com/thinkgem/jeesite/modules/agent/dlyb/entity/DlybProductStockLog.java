 ...
 * @version 2018-08-07
 */
public class DlybProductStockLog extends DataEntity<DlybProductStockLog> {
	...
	private int beforenum;		// 之前库存
	private int changenum;		// 库存改变量
	private Date beginCreateDate;		// 开始 创建时间
	private Date endCreateDate;		// 结束 创建时间
	
	public DlybProductStockLog() {
		super();
	}

	public DlybProductStockLog(String id){
		super(id);
	}
