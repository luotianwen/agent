...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/stock/stock/">库存列表</a></li>
		<li class="active"><a href="${ctx}/stock/stock/form?id=${stock.id}">库存<shiro:hasPermission name="stock:stock:edit">${not empty stock.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="stock:stock:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="stock" action="${ctx}/stock/stock/save" method="post" class="form-horizontal">
		...
		<div class="form-actions">
			<shiro:hasPermission name="stock:stock:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
