...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/bsimpleorder/">下单管理列表</a></li>
		<li class="active"><a href="${ctx}/bsimpleorder/form?id=${simpleOrder.id}">下单管理 ${not empty simpleOrder.id?'修改':'添加'}   </a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="simpleOrder" action="${ctx}/bsimpleorder/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
