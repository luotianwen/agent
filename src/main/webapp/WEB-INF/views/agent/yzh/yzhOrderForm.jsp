...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctx}/yzh/yzhOrder/form?id=${yzhOrder.id}">云中鹤订单管理<shiro:hasPermission name="yzh:yzhOrder:edit">${not empty yzhOrder.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="yzh:yzhOrder:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="yzhOrder" action="${ctx}/yzh/yzhOrder/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="control-group">
			<label class="control-label">商品ID_数量：</label>
			<div class="controls">
				<form:input path="pidNums" htmlEscape="false" readonly="true" maxlength="255" class="input-xlarge "/>
			</div>
		</div>
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:select path="province" class="input-xlarge" onchange="getcity()">
					<form:option value="" label="选择"/>
					<form:options items="${provices}" itemLabel="name"  itemValue="code" htmlEscape="false"/>
				</form:select>
			</div>
		</div>
		<div class="control-group">
			...
			<div class="controls">
				<select id="city" name="city" class="input-xlarge select2-offscreen" tabindex="-1" onchange="getcounty()">
		...
		<div class="control-group">
			...
			<div class="controls">
				<select id="county" name="county" class="input-xlarge select2-offscreen" tabindex="-1"  >
	...
	<div class="control-group">
		...
		<div class="control-group">
			<label class="control-label">售后id：</label>
			<div class="controls">
				<form:input path="serviceOrder" htmlEscape="false" maxlength="255" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
