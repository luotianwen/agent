...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/agent/supplier/">供应商管理列表</a></li>
		<li class="active"><a href="${ctx}/agent/supplier/form?id=${supplier.id}">供应商管理<shiro:hasPermission name="agent:supplier:edit">${not empty supplier.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="agent:supplier:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="supplier" action="${ctx}/agent/supplier/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="form-actions">
			<shiro:hasPermission name="agent:supplier:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
